...
abstract class BukkitClassSystem(player: Player) : ClassSystem {
    ...
    class Provider(
        ...
        private val constructor: (Player) -> BukkitClassSystem
    ) : ClassSystem.Provider<BukkitClassSystem> {

        override fun get(arg: Any): BukkitClassSystem = constructor(arg as Player)
    }
}
